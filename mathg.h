...
*
*### Platforms
*Currently Windows x86 only, but in perspective can be ported on every platform that provides OpenGL > 3.0 API. In nearest future I plan to port it on Linux x86.
*
*### Installation
